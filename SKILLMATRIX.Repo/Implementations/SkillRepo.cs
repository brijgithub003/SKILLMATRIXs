    ...
    public class SkillRepo : ISkillRepo
    {
        ...
        public string Delete(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SKILLS_GET_INSERT_UPDATE";
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add(new OracleParameter() { ParameterName = "SKILL_ID", OracleDbType = OracleDbType.Double, Value = id });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "SKILL_NAME", OracleDbType = OracleDbType.Varchar2 });
        ...
        public async Task<DataTable> GetAll()
        {
            ...
            try
            {
                _context.Database.OpenConnection();
                DbCommand cmd = _context.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "SKILLS_GET_INSERT_UPDATE";  //Use proc noame 
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Save(SkillViewModel vm)
        {
            string res = "";
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "SKILL_ID", OracleDbType = OracleDbType.Double });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "SKILL_NAME", OracleDbType = OracleDbType.Varchar2, Value = vm.Skill_Name });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
        ...
        public string Update(SkillViewModel vm)
        {
            string res = "";
            try
            {
