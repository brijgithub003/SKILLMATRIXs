...
namespace SKILLMATRIX.Repo.Implementations
{
    public class PlantRepo : IPlantRepo
    {
        ...
        public PlantRepo(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public string Delete(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "PLANTS_GET_INSERT_UPDATE";
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_ID", OracleDbType = OracleDbType.Double, Value = id });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_NAME", OracleDbType = OracleDbType.Varchar2 });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_CODE", OracleDbType = OracleDbType.Varchar2 });
        ...
        public async Task<DataTable> GetAll()
        {
            ...
            try
            {
                _context.Database.OpenConnection();
                DbCommand cmd = _context.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "PLANTS_GET_INSERT_UPDATE";  //Use proc noame 
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetDataTable()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_ID", OracleDbType = OracleDbType.Double });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_NAME", OracleDbType = OracleDbType.Varchar2 });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_CODE", OracleDbType = OracleDbType.Varchar2 });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
        ...
        public string Save(PlantViewModel vm)
        {
            string res = "";
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_ID", OracleDbType = OracleDbType.Double });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_NAME", OracleDbType = OracleDbType.Varchar2, Value = vm.Plant_Name });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_CODE", OracleDbType = OracleDbType.Varchar2, Value = vm.Plant_Code });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
        ...
        public string Update(PlantViewModel vm)
        {
            string res = "";
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_ID", OracleDbType = OracleDbType.Double,Value = vm.Plant_Id });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_NAME", OracleDbType = OracleDbType.Varchar2, Value = vm.Plant_Name });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "PLANT_CODE", OracleDbType = OracleDbType.Varchar2, Value = vm.Plant_Code });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
