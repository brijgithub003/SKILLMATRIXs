...
namespace SKILLMATRIX.Repo.Implementations
{
    public class EducationRepo :IEducationRepo
    {
        ...
        public EducationRepo(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public string Delete(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "EDUCATION_GET_INSERT_UPDATE";
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_ID", OracleDbType = OracleDbType.Double, Value = id });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_NAME", OracleDbType = OracleDbType.Varchar2 });
        ...
        public async Task<DataTable> GetAll()
        {
            ...
            try
            {
                _context.Database.OpenConnection();
                DbCommand cmd = _context.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "EDUCATION_GET_INSERT_UPDATE";  //Use proc noame 
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetDataTable()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_ID", OracleDbType = OracleDbType.Double });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_NAME", OracleDbType = OracleDbType.Varchar2 });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
        ...
        public string Save(EducationViewModel vm)
        {
            string res = "";
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_ID", OracleDbType = OracleDbType.Double });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_NAME", OracleDbType = OracleDbType.Varchar2, Value = vm.Education_Name });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
        ...
        public string Update(EducationViewModel vm)
        {
            string res = "";
            try
            {
                ...
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_ID", OracleDbType = OracleDbType.Double, Value = vm.Education_Id });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "EDUCATION_NAME", OracleDbType = OracleDbType.Varchar2, Value = vm.Education_Name });
                cmd.Parameters.Add(new OracleParameter() { ParameterName = "ISACTIVE", OracleDbType = OracleDbType.Double });
